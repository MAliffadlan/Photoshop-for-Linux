...
LOCAL_LINKS = {
    **DOCUMENTS,
    ...
    "LICENSE": "../../licenses/mectov/LICENSE",
    "licenses/rawler-LGPL-2.1.txt": "../../licenses/mectov/rawler-LGPL-2.1.txt",
    "assets/fonts/Inter-LICENSE.txt": "../../licenses/mectov/Inter-LICENSE.txt",
    "vendor/egui-winit/LICENSE-MIT": "../../licenses/mectov/egui-winit/LICENSE-MIT",
    "vendor/egui-winit/LICENSE-APACHE": "../../licenses/mectov/egui-winit/LICENSE-APACHE",
}
...
def main():
    ...
    archive = f"mectov-{args.version}-source.tar.gz"
    (args.destination / "SOURCES.md").write_text(
        f"# Sources for mectov {args.version}\n\n"
        ...
        f"directory, enter `mectov-{args.version}-source`, edit `vendor/rawler` if desired, "
    ...
    (args.destination / "copyright").write_text(
        ...
        + "\nDependency licenses are under share/licenses/mectov in this installation.\n\n"
