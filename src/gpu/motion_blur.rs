    ...
    pub fn render(
        ...
        let pipeline = self.pipeline.get_or_init(|| {
            let shader = self
                ...
                .create_shader_module(wgpu::ShaderModuleDescriptor {
                    label: Some("mectov full-resolution motion blur"),
            ...
            && [texture.width(), texture.height()] == [pixels.width(), pixels.height()]
        {
            ...
            self.device.create_texture_with_data(
                ...
                &wgpu::TextureDescriptor {
                    label: Some("mectov full-resolution filter source"),
                    size: wgpu::Extent3d {
                        width: pixels.width(),
        ...
        let uniform = self
            ...
            .create_buffer_init(&wgpu::util::BufferInitDescriptor {
                label: Some("mectov motion blur samples"),
                contents: bytemuck::bytes_of(&params),
                usage: wgpu::BufferUsages::UNIFORM,
            });
        let readback = self.device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("mectov filtered layer readback"),
            size: buffer_size,
        ...
        let bind = self.device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("mectov motion blur inputs"),
        ...
        let mut encoder = self
            ...
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("mectov apply motion blur"),
            });
        {
